...
(pc <- ggplot(res_final, aes(interaction(alpha, name), method, fill = std)) +
    ...
    annotate(geom = 'text', x = 2, y = 15.1, vjust = 1, hjust = .5, color = 'grey0',
             label = 'Percentage of\nconflicting results\n(Conflict%)', size = 2.5) +
    annotate(geom = 'text', x = 5, y = 15.1, vjust = 1, hjust = .5, color = 'grey0',
             label = 'Replication\npercentage\n(Replication%)', size = 2.5) +
    annotate(geom = 'text', x = 8, y = 15.1, vjust = 1, hjust = .5, color = 'grey0',
             label = 'Percentage of\nopposite estimates\n(Opposite%)', size = 2.5) +
    annotate(geom = 'text', x = 11, y = 15.1, vjust = 1, hjust = .5, color = 'grey0',
             label = 'Overlap percentage\nof conf. intervals\n(CI%)', size = 2.5) +
    annotate(geom = 'text', x = 14, y = 15.1, vjust = 1, hjust = .5, color = 'grey0',
             label = 'Number of\nsignificant taxa\n(NHits)', size = 2.5) +
    ...
    labs(title = 'Figure 4: Results of the separate study analyses', x = xt) +
    theme_minimal() +
...
ggsave(filename = paste0('fig_4_', date,'.png'),
       plot = pc, width = 170, height = 120, dpi = 300, unit = 'mm',
       bg = 'white')
